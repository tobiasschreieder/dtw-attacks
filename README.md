...
Generative Adversarial Networks (GAN), each with 10,000 subjects, are integrated into the project to test the 
...
* [Conditional GAN (cGAN) and DoppelGANger (DGAN):](https://github.com/luckyos-code/Privacy-Preserving-Smartwatch-Health-Data-Generation-Using-DP-GANs)
The cGAN and DGAN data set were created with the implementation of the linked project. Using the WESAD data set as a basis, 
10,000 synthetic subjects were created. The created cGAN and DGAN data set can be downloaded from Zenodo. The data sets should be save unzipped under
  experiments/dataset/WESAD_cGAN and experiments/dataset/WESAD_DGAN.
  
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.14734046.svg)](https://doi.org/10.5281/zenodo.14734046)
